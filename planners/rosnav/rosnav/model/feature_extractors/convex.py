...
class ConvexExtractor_2d_with_ActPts_4(ConvexExtractor_2d_with_ActPts):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # init father class
        super(ConvexExtractor_2d_with_ActPts_4,self).__init__(
            observation_space=observation_space,
            observation_space_manager=observation_space_manager,
            features_dim=features_dim,
            stacked_obs=stacked_obs,
    ...
    def _setup_network(self):
        ...
        # )
        self.cnn = nn.Sequential(
            nn.Conv2d(self._num_stacks, 32, kernel_size=5, stride=3, padding=1),
            nn.ReLU(),
            nn.Conv2d(32, 64, kernel_size=3, stride=2, padding=1),
            nn.ReLU(),
            nn.Conv2d(64, 128, kernel_size=3, stride=1, padding=1),
...
class ConvexExtractor_2d_with_ActPts_5(ConvexExtractor_2d_with_ActPts):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # init father class
        super(ConvexExtractor_2d_with_ActPts_5,self).__init__(
            observation_space=observation_space,
            observation_space_manager=observation_space_manager,
            features_dim=features_dim,
            stacked_obs=stacked_obs,
    ...
    def _setup_network(self):
        ...
        # )
        self.cnn = nn.Sequential(
            nn.Conv2d(self._num_stacks, 32, kernel_size=7, stride=3, padding=0),
            nn.ReLU(),
