...
class RosnavSpaceManager:
    ...
    def __init__(
        ...
        if self._stacked :
            print("RosnavSpaceManager init with stacked_obs")
        else:
            print("RosnavSpaceManager init without stacked_obs")
    ...
    def process_action(self, action, action_obs_dict: Dict[str, Any]):
        ...
        """
        return self._encoder.process_action(action, action_obs_dict)
