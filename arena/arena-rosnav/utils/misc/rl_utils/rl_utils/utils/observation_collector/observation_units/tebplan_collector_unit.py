...
class TebplanCollectorUnit(CollectorUnit):
    """
    ...
    def get_observations(
        ...
        obs_dict.update(
            {
                OBS_DICT_KEYS.TEB_PLAN: self._globalplan,
            }
        )
        return obs_dict
    ...
    def _cb_globalplan(self, globalplan_msg: Path):
        ...
        """
        self._globalplan = TebplanCollectorUnit.process_global_plan_msg(
            globalplan_msg
        )
